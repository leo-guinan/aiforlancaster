...
- **Ubersuggest** — Free tier gives you a few searches per day. Good enough for local research.
...
2. **Website traffic from organic search.** Google Analytics is free. Google Search Console is free. Install both. Search Console specifically shows you which queries are bringing people to your site and your average position for those queries. This is how you know if your content is ranking.

3. **Leads or sales.** Whatever your conversion is — phone calls, form submissions, appointments booked — track it. If you can't connect a lead to a source, ask new customers how they found you. Old-fashioned, but it works.
